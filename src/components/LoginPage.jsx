...
export default function LoginPage(params) {
    ...
    const[redirected,setRedicted] = useState(false)
    ...
    return (
        <div className="mt-4 mb-4 grow flex items-center justify-around ">
            <div className="mb-64">
                ...
                <form className="max-w-md mx-auto border-gray-300" onSubmit={loginSubmit}>
                    ...
                    Don't have a Accont ? <Link to={'/register'} className="underline text-black">Register Now</Link>
                    </div>
                </form>
            </div>
        </div>
